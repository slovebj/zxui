...
+function ($) {
    ...
    $(function() {
        var INIT_NAVTAB = function() {
            ...
            var mainTit='首页', options;
            
            $main.navtab('contextmenu', $main).click(function() { $(this).navtab('switchTab', 'main') });
            /**.find('> a > span').html(function(n, c) { return (mainTit = c.replace('#maintab#', '首页')) })
            **/
